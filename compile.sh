...
compile_dts() {
        make ARCH=arm nxp/imx/imx6ull-var-dart-6ulcustomboard-emmc-sd-card.dtb
        make ARCH=arm nxp/imx/imx6ull-var-dart-6ulcustomboard-nand-sd-card.dtb
		make ARCH=arm nxp/imx/imx6ull-var-dart-6ulcustomboard-nand-wifi-brcm.dtb
		make ARCH=arm nxp/imx/imx6ull-var-dart-6ulcustomboard-nand-wifi-iw61x.dtb
        cp arch/arm/boot/dts/nxp/imx/imx6ull-var-dart*.dtb $2
}
